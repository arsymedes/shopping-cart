...
function Cart() {
  return (
    <main className="flex flex-col pt-36 px-8 sm:px-24 gap-6 sm:gap-12 scrollbar-thin scrollbar-track-white scrollbar-thumb-black">
      ...
      <ul className="flex flex-col sm:gap-6 mb-20">
        <CartEntry />
        <CartEntry />
      </ul>
      <div className="text-xl sm:text-3xl font-bold fixed bottom-0 left-0 h-20 w-screen flex justify-end items-center px-8 sm:px-24 bg-white">
